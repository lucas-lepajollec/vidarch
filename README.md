...
**VidArch** is an independent, self-hosted media platform designed to archive your favorite YouTube channels, download high-resolution videos (up to 4K/60fps) automatically or on-demand, and provide an ultra-slick, modern browsing and playback experience without ads, sponsors, or tracking.
...
- 🎯 **Pixel-Perfect Responsive UI**: Dark mode interface with modern fluid layout across desktop, tablet, and mobile (full-screen mobile search overlay, navigation drawer, responsive 4-column cards).
...
- 📡 **Automated Subscriptions Radar**: Background scheduler (`node-cron`) that periodically checks subscribed channels for new uploads and downloads them automatically.
